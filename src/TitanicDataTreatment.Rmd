...
A continuación se muestran las estadísticas básicas del conjunto de datos para identificar posibles valores extremos (*outliers*) en las variables **Age**, **SibSp**, **Parch** y **Fare**.
